...
def texture2(humfile, sonpath, win, doplot,  numclasses): 
      ...
      ft = 1/loadmat(os.path.normpath(os.path.join(sonpath,base+'meta.mat')))['pix_m']
      ...
      # load memory mapped scan ... port
      shape_star = np.squeeze(loadmat(os.path.normpath(os.path.join(sonpath,base+'meta.mat')))['shape_star'])
      if shape_star!='':
      ...
      dist_m = np.squeeze(loadmat(os.path.normpath(os.path.join(sonpath,base+'meta.mat')))['dist_m'])
