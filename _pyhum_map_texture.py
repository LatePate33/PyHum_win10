...
def map_texture(humfile, sonpath, cs2cs_args, res, mode, nn, numstdevs): #influence = 10, 
    ...
    if len(shape_star)>2:    
       for p in range(len(class_fp)):
          ...
          # make maximum merge length same as len(X)
          if len(merge) != len(X):
             merge = merge[:len(X)]
       ...
       #print(np.size(merge)) #10211016
       #print(len_n) #3452
       #print(len(X)) #5102056
       #print(len(Y)) #5102056
       #print(len(merge.flatten())) #10211016

       if len(merge.flatten()) != len(X):
          merge = merge[:,:len_n]

       #print(np.size(merge)) #5105508
       merge = merge.T.flatten()
       ...
       index = np.where(np.logical_not(np.isnan(merge)))[0]
       #print(index)
       #print(np.size(index)) #4516973 -> #4513778
       #print(np.size(X)) #5102056
       #print(np.size(Y)) #5102056
       #print(np.size(merge)) #5105508 -> #5102056
